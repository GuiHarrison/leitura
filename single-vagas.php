    ...
    <div class="row">
      <div class="col-md-12 col-lg-12">
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post();
            ...
            $identidade = get_field('identidade_rh');
            $endereco = get_field('endereco_rh');
            $numero = get_field('endereco_2_rh');
            $complemento = get_field('endereco_3_rh');
            ...
            $instituto_ensino = get_field('instituto_rh');
            ...
            $outro_idioma = get_field('outro_rh');
            ...
            <div class="detalhes_conta">
              ...
              <div class="row remove-print">
                <div class="col-md-2 col-lg-2">
                  <div class="list-infor">
                    <a href="" onclick="window.close();" class="volta"> Voltar</a>
                  </div>
                </div>
                <?php if (current_user_can('read')): ?>
                  <div class="col-md-10 col-lg-10">
                    <form class="form-user" method="post" action="">
                      ...
                      <!-- <select name="select_status_<?php echo $id_post; ?>">
									<option <?php if ($status_lido_nao == 'lido') echo "selected='selected'"; ?> value="lido">lido</option>
									<option <?php if ($status_lido_nao == 'nao-lido') echo "selected='selected'"; ?> value="nao-lido">Não Lido</option>
								</select> -->

                      <select name="select_aprovacao_<?php echo $id_post; ?>">
                        <option
                          <?php if (
                      ...
                      <div class="destaque_curriculo">
                        <span>Destacar</span>
                        <select name="select_destacar_<?php echo $id_post; ?>">
                      ...
                      <a class="delete_cliente" onclick="return confirm('Tem certeza que deseja deletar currículo de <?php the_title(); ?> <?php echo $sobre_nome; ?>?')" href="<?php echo get_delete_post_link($post->ID) ?>">Deletar</a>
              ...
              <div class="bloco_dados">
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-6">
                    <strong>Telefone Residencial:</strong> <?php echo $telefone; ?><br />
                  ...
                  <div class="col-md-6 col-lg-6">
                    ...
                    <strong>Identidade:</strong> <?php echo $identidade; ?><br />
              ...
              <div class="bloco_dados">
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-6">
                    ...
                    <strong>Instituição de Ensino:</strong> <?php echo $instituto_ensino; ?><br />
              ...
              <div class="bloco_dados">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6">
                    ...
                    <strong>Contato na empresa (Nome e telefone):</strong> <?php echo $contato_empresa; ?>
                  </div>
                </div>
              </div>
              <div class="bloco_dados">
              ...
              <div class="bloco_dados">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-lg-4">
                    <strong>Outro:</strong> <?php echo $outro_idioma; ?>
                  </div>
                </div>
              </div>
